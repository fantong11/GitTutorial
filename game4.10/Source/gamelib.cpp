...
void CGameState::ShowInitProgress(int percent)
{
	...
	loading.LoadBitmap(IDB_LOADAD, RGB(0,0,0));
	//loading.SetTopLeft((SIZE_X - loading.Width()) / 2, -SIZE_Y / 48);
	...
	// b1(DEFAULT_BG_COLOR);				// 畫黑色 progrss中心
	//pDC->SelectObject(&b1);
...
: NUM_GAME_STATES(8)
{
	...
	gameStateTable[GAME_STATE_STAGE2] = new CGameStateStage2(this);
	gameStateTable[GAME_STATE_STAGE3] = new CGameStateStage3(this);
	gameState = NULL;
}
